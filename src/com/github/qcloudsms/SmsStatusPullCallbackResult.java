...
public class SmsStatusPullCallbackResult extends SmsResultBase {
	...
	public class Callback {
		...
		public String toString() {
			String[] fields = { "user_receive_time", "nationcode", "mobile", "report_status", "errmsg", "description",
					"sid" };
	...
	@Override
	public SmsStatusPullCallbackResult parseFromHTTPResponse(HTTPResponse response) throws JSONException {
